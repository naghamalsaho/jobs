            ...
            child: Column(
              ...
              children: [
                Container(
                  height: 60,
                  child: TabBar(
                    indicatorColor:AppColor.PraimaryColor() ,
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      GetBuilder<NewsController>(
                        builder: (newsController) => ListView.builder(
                          itemCount: filesUrl!.length,
                          itemBuilder: (context, index) {
                            return PdfCard(
                              isLoudingPdf: newsController.isLoading[filesUrl!
                                      .isNotEmpty
                                  ? '${AppLink.serverimage}/${filesUrl![index].url}'
                                  : ' '],
                              name: filesUrl![index].url!.split("/").last,
                              onPressed: () async {
                                await newsController.download(
                                    '${filesUrl![index].url!}',
